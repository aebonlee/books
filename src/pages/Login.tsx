...
function LoginContent() {
  ...
  }, [isLoggedIn, isLoading, from, navigate]);
  ...
  if (isLoading || isLoggedIn) {
    return (
      <section className="auth-fullpage">
        <div className="auth-center-wrapper" style={{ textAlign: 'center', color: '#6b7280' }}>
          {ko ? '로딩 중...' : 'Loading...'}
        </div>
      </section>
    );
          ...
          {step === 'method' ? (
            <>
              <div className="auth-methods">
                ...
                <button
                  className="auth-method-btn kakao"
